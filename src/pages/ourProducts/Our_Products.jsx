    ...
    <div className="ourProducts">
      <Container path="C:\Our Products">
        <div className="productsHeader">
          ...
          <div className="showingArea">
            ...
            <div className="showingFunction">
              <label htmlFor="per_page" style={{ marginRight: "10px" }}>
                Displaying:
              </label>
        ...
        <div className="albunsArea">
          <Link
            className="link"
            to={`/OurProducts/macintosh-plus-floral-shoppe`}
          >
            <Card
              albumFrontImage={mpAlbumFront}
              albumBackImage={mpAlbumBack}
              albumName="Macintosh Plus - Floral Shoppe"
              albumPrice="$40.50"
            />
          </Link>
          ...
          <Link className="link" to={`/OurProducts/saint-pepsi-hit-vibes`}>
            <Card
              albumFrontImage={spAlbumFront}
              albumBackImage={spAlbumBack}
              albumName="Saint Pepsi - Hit Vibes"
              albumPrice="$37.75"
            ></Card>
          </Link>
          ...
          <Link
            className="link"
            to={`/OurProducts/blank-banshee-blank-banshee-zero`}
          >
            <Card
              albumFrontImage={bbAlbumFront}
              albumBackImage={bbAlbumBack}
              albumName="Blank Banshee - Blank Banshee 0"
              albumPrice="$49.99"
            />
          </Link>
          ...
          <Link className="link" to={`/OurProducts/webinar-deepdive`}>
            <Card
              albumFrontImage={wbAlbumFront}
              albumBackImage={wbAlbumBack}
              albumName="Webinar™ - www.deepdive.com"
              albumPrice="$60.53"
            ></Card>
          </Link>
          ...
          <Link
            className="link"
            to={`/OurProducts/windows96-date-new-aesthetic`}
          >
            <Card
              albumFrontImage={w9AlbumFront}
              albumBackImage={w9AlbumBack}
              albumName="Windows96 - Dated New Aesthetic"
              albumPrice="$36.40"
            />
          </Link>
          ...
          <Link className="link" to={`/OurProducts/macroblank-missing`}>
            <Card
              albumFrontImage={mbAlbumFront}
              albumBackImage={mbAlbumBack}
              albumName="Macroblank - 行方不明"
              albumPrice="$43.90"
            ></Card>
          </Link>
          ...
          <Link className="link" to={`/OurProducts/slowerpace-lost-in-space`}>
            <Card
              albumFrontImage={srpAlbumFront}
              albumBackImage={srpAlbumBack}
              albumName="slowerpace 音楽 - Lost in space 宇宙の冒険"
              albumPrice="$50.59"
            />
          </Link>
          ...
          <Link className="link" to={`/OurProducts/oscob-praise-the-sun-god`}>
            <Card
              albumFrontImage={oAlbumFront}
              albumBackImage={oAlbumBack}
              albumName="OSCOB - praise the sun god"
              albumPrice="$62.90"
            ></Card>
          </Link>
          ...
          <Link className="link" to={`/OurProducts/time-fragment-ironclad`}>
            <Card
              albumFrontImage={tfAlbumFront}
              albumBackImage={tfAlbumBack}
              albumName="Time Fragment - 装甲艦"
              albumPrice="$66.60"
            ></Card>
          </Link>
        </div>
